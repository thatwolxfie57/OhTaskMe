...
urlpatterns = [
    ...
    # Task management (avoiding conflict with /api/tasks/ router)
    path('move-task/', api_views.move_task, name='move_task'),
    path('quick-create-task/', api_views.quick_create_task, name='quick_create_task'),
